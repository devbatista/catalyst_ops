...
module MercadoPago
  class Client
    ...
    def initialize(access_token: MP_ACCESS_TOKEN, base_url: MP_API_BASE)
      ...
      Rails.logger.info("MercadoPago::MP_TEST_ACCESS_TOKEN: #{MP_TEST_ACCESS_TOKEN}")
      Rails.logger.info("MercadoPago::MP_PRODUCTION_ACCESS_TOKEN: #{MP_PRODUCTION_ACCESS_TOKEN}")
    end
